                    ...
                    <div class="table-responsive ">
                        <table class="table table-bordered" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td rowspan="5">
                                    ...
                                    <div class="image-area mt-0 rounded">
                                        ...
                                        <img src="#" alt="" class="img-fluid rounded shadow imageresult" height="300px" width="300px">
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-12">
                                        <input type="date" class="form-control" name="insdate" id="insdate" value="<?php echo date("d-m-Y") ?>">
                                    </div>
                                </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-12">
                                        <input type="date" class="form-control" name="insdate" id="einsdate" value="<?php echo date("d-m-Y") ?>">
                                    </div>
                                </td>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-dark">Unit Profile
                ...
                <a href="<?php echo base_url('exportUnits') ?>" class="btn btn-outline-success float-right"><i class="fas fa-file-excel"></i>
                    Export</a>
